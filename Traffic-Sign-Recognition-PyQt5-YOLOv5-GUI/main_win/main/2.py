...
# 单个图像处理大模块
        ...
        # 在您的类初始化函数中，添加以下代码以连接新功能
        self.imageEnhanceButton.clicked.connect(self.apply_image_enhance)
        self.imageFilterButton.clicked.connect(self.apply_image_filter)
        self.morphologyButton.clicked.connect(self.apply_morphology)
        self.histogramButton.clicked.connect(self.apply_histogram)
        #打开一个文件夹选择上一个下一个
        self.image_list = []
