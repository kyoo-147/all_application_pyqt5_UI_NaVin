...
class KeyGenerationThread(QThread):
    ...
    found_keys_scanned_edit = pyqtSignal(int, str)
    ...
    def run(self):
        def process_address(address, private_key):
            if address in addfind:
                ...
                self.found_keys_scanned_edit.emit(self.found_count__slot, found_data)
...
class WinnerDialog(QDialog):
    def __init__(self, WINTEXT, parent=None):
        ...
        self.setWindowTitle("QTMizICE.py  WINNER")
...
class CryptoHunterApp(QWidget):
    def __init__(self):
        ...
        self.setGeometry(80, 80, 920, 560)
        self.initUI()
    ...
    def initUI(self):
        ...
        title_label = QLabel('<html><center><font size="5">❤️ Good Luck and Happy Hunting MIzogg ❤️</font></center></html>')
    ...
    def start(self):
        ...
        if self.end_hex < self.start_hex:
            ...
            for i in range(num_cpus):
                ...
                thread.found_keys_scanned_edit.connect(self.found_count_slot)
    ...
    def found_count_slot(self, found_count, data):
